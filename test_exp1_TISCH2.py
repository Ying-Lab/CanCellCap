...
results_path = './results/exp1_TISCH2/'
...
def plot_multiple_roc(loader, dataset_name=""):
    ...
    plt.grid(True)
    plt.show()
    plt.savefig(f'./results/fig/exp1_TISCH2_roc_{dataset_name}.pdf')
    return results_df
...
results.to_csv(f'./results/exp1_TISCH2_results.csv', index=False)
