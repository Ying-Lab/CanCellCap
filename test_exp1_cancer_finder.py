...
SPL_PATH = "./data/exp1_cancer_finder"
...
results_path = './results/exp1_cancer_finder/'
...
def plot_multiple_roc(loader, dataset_name=""):
    ...
    plt.grid(True)
    plt.show()
    plt.savefig(f'./results/fig/exp1_cancer_finder_roc_{dataset_name}.pdf')
    return results_df
...
results.to_csv(f'./results/exp1_cancer_finder_results.csv', index=False)
