...
import torch
import pandas as pd 
from models import CanCellCap, Cancer_Finder_model
...
from TISCH import *
import torch
from sklearn.metrics import confusion_matrix, ConfusionMatrixDisplay, f1_score, roc_curve, auc, accuracy_score, precision_score, recall_score
import numpy as np
...
args.val_dir = './data/st/'#colorectal 
